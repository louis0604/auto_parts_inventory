...
type PartFormData = {
  ...
  replCost?: string; // Replacement Cost
  avgCost?: string; // Average Cost
  price1?: string; // Price 1
  price2?: string; // Price 2
  price3?: string; // Price 3
