...
export function CreditFormWithSalesHistory({ open, onClose, onSuccess }: CreditFormProps) {
  ...
  const getSalesHistory = trpc.credits.getSalesHistory.useQuery(searchingSku, {
    enabled: false,
  });
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="reason" {...register("reason")} rows={2} placeholder="请说明退货原因..." />
          </div>

          {/* Items Section */}
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <Label className="text-lg font-semibold">退货配件</Label>
              <Button
                type="button"
                variant="outline"
                size="sm"
