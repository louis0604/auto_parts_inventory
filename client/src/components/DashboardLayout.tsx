...
import { LayoutDashboard, LogOut, PanelLeft, Users, Package, TruckIcon, ShoppingCart, FileText, BarChart3, Sparkles, RotateCcw, Shield, Tag, Car, Layers, History, SearchCheck } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Tag, label: "Line Code管理", path: "/line-codes" },
...
function DashboardLayoutContent({
  ...
  const user = { name: "admin", email: "admin@local" };
